...
function crearGato(nombre, edad) {
  ...
  const nuevoGato = { 
 nombre: nombre, //Clave o propiedad: Value. 
 edad: edad,
 meow: function(){ //Metodo es tambien funcion (Se dice de ambas maneras)
   return "Meow!"; 
 }
  }; 
 return nuevoGato; 
...
function actualizarPassword(usuario, nuevaPassword) {
  ...
  // Devuelve el objeto
  // Tu código:
  usuario.password = nuevaPassword; //Agregando nuevo valor 
  return usuario; 
...
//Otra forma: 
//producto.calcularPrecioConDescuento= function(){
//var descuento=0: 
